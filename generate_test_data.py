...
def generar_datos_prueba():
    ...
    materiales_data = [
        ...
        {'nombre': 'Cemento Portland (saco 25kg)', 'familia': 'Cemento', 'unidad': 'ud', 'precio_compra': 8.50, 'precio_venta': 10.50},
        {'nombre': 'Arena lavada (m³)', 'familia': 'Áridos', 'unidad': 'm³', 'precio_compra': 25.00, 'precio_venta': 30.00},
        {'nombre': 'Grava (m³)', 'familia': 'Áridos', 'unidad': 'm³', 'precio_compra': 28.00, 'precio_venta': 35.00},
        {'nombre': 'Ladrillo hueco doble', 'familia': 'Ladrillos', 'unidad': 'ud', 'precio_compra': 0.35, 'precio_venta': 0.45},
        {'nombre': 'Ladrillo macizo', 'familia': 'Ladrillos', 'unidad': 'ud', 'precio_compra': 0.45, 'precio_venta': 0.55},
        {'nombre': 'Bloque hormigón 20x20x40', 'familia': 'Bloques', 'unidad': 'ud', 'precio_compra': 1.20, 'precio_venta': 1.50},
        {'nombre': 'Mortero preparado (saco 25kg)', 'familia': 'Morteros', 'unidad': 'ud', 'precio_compra': 6.80, 'precio_venta': 8.50},

        # Materiales de acabado
        {'nombre': 'Azulejo blanco 20x20', 'familia': 'Azulejos', 'unidad': 'm²', 'precio_compra': 12.50, 'precio_venta': 16.00},
        {'nombre': 'Gres porcelánico imitación madera', 'familia': 'Pavimentos', 'unidad': 'm²', 'precio_compra': 28.00, 'precio_venta': 36.00},
        {'nombre': 'Pintura plástica blanca interior (15L)', 'familia': 'Pintura', 'unidad': 'ud', 'precio_compra': 45.00, 'precio_venta': 55.00},
        {'nombre': 'Pintura esmalte satinado (4L)', 'familia': 'Pintura', 'unidad': 'ud', 'precio_compra': 32.00, 'precio_venta': 40.00},
        {'nombre': 'Yeso blanco (saco 25kg)', 'familia': 'Yesos', 'unidad': 'ud', 'precio_compra': 7.50, 'precio_venta': 9.50},
        {'nombre': 'Pladur tipo A 13mm', 'familia': 'Placas', 'unidad': 'm²', 'precio_compra': 8.90, 'precio_venta': 11.50},

        # Materiales eléctricos
        {'nombre': 'Cable RZ1-K 1x2,5mm² (rollo 100m)', 'familia': 'Cables', 'unidad': 'ud', 'precio_compra': 45.00, 'precio_venta': 55.00},
        {'nombre': 'Cable RZ1-K 1x4mm² (rollo 100m)', 'familia': 'Cables', 'unidad': 'ud', 'precio_compra': 68.00, 'precio_venta': 85.00},
        {'nombre': 'Tubo corrugado PVC Ø20mm (rollo 50m)', 'familia': 'Tubos Eléctricos', 'unidad': 'ud', 'precio_compra': 15.50, 'precio_venta': 19.50},
        {'nombre': 'Caja mecanismos universal', 'familia': 'Mecanismos', 'unidad': 'ud', 'precio_compra': 0.45, 'precio_venta': 0.65},
        {'nombre': 'Interruptor blanco', 'familia': 'Mecanismos', 'unidad': 'ud', 'precio_compra': 3.20, 'precio_venta': 4.50},
        {'nombre': 'Base enchufe schuko blanca', 'familia': 'Mecanismos', 'unidad': 'ud', 'precio_compra': 3.80, 'precio_venta': 5.20},
        {'nombre': 'Cuadro eléctrico 24 elementos', 'familia': 'Cuadros Eléctricos', 'unidad': 'ud', 'precio_compra': 65.00, 'precio_venta': 85.00},
        {'nombre': 'Magnetotérmico 2P 25A', 'familia': 'Protecciones', 'unidad': 'ud', 'precio_compra': 12.50, 'precio_venta': 16.00},
        {'nombre': 'Diferencial 2P 40A 30mA', 'familia': 'Protecciones', 'unidad': 'ud', 'precio_compra': 35.00, 'precio_venta': 45.00},

        # Fontanería
        {'nombre': 'Tubo multicapa Ø16mm (barra 5m)', 'familia': 'Tubería', 'unidad': 'ud', 'precio_compra': 18.00, 'precio_venta': 23.00},
        {'nombre': 'Tubo multicapa Ø20mm (barra 5m)', 'familia': 'Tubería', 'unidad': 'ud', 'precio_compra': 24.00, 'precio_venta': 30.00},
        {'nombre': 'Codo multicapa 90° Ø16mm', 'familia': 'Accesorios Fontanería', 'unidad': 'ud', 'precio_compra': 0.85, 'precio_venta': 1.10},
        {'nombre': 'Codo multicapa 90° Ø20mm', 'familia': 'Accesorios Fontanería', 'unidad': 'ud', 'precio_compra': 1.10, 'precio_venta': 1.45},
        {'nombre': 'Llave de paso Ø20mm', 'familia': 'Llaves y Válvulas', 'unidad': 'ud', 'precio_compra': 8.50, 'precio_venta': 11.00},
        {'nombre': 'Grifo monomando lavabo cromado', 'familia': 'Grifería', 'unidad': 'ud', 'precio_compra': 45.00, 'precio_venta': 60.00},
        {'nombre': 'Grifo monomando ducha cromado', 'familia': 'Grifería', 'unidad': 'ud', 'precio_compra': 65.00, 'precio_venta': 85.00},
        {'nombre': 'Inodoro completo con tapa', 'familia': 'Sanitarios', 'unidad': 'ud', 'precio_compra': 120.00, 'precio_venta': 155.00},
        {'nombre': 'Lavabo suspendido 60cm', 'familia': 'Sanitarios', 'unidad': 'ud', 'precio_compra': 85.00, 'precio_venta': 110.00},

        # Carpintería
        {'nombre': 'Puerta interior lisa blanca 72,5x203', 'familia': 'Puertas', 'unidad': 'ud', 'precio_compra': 95.00, 'precio_venta': 120.00},
        {'nombre': 'Puerta interior lisa blanca 82,5x203', 'familia': 'Puertas', 'unidad': 'ud', 'precio_compra': 105.00, 'precio_venta': 135.00},
        {'nombre': 'Marco puerta blanco 72,5cm', 'familia': 'Marcos', 'unidad': 'ud', 'precio_compra': 28.00, 'precio_venta': 36.00},
        {'nombre': 'Marco puerta blanco 82,5cm', 'familia': 'Marcos', 'unidad': 'ud', 'precio_compra': 32.00, 'precio_venta': 42.00},
        {'nombre': 'Manivela puerta cromada', 'familia': 'Herrajes', 'unidad': 'ud', 'precio_compra': 12.50, 'precio_venta': 16.50},
        {'nombre': 'Cerradura embutir 40mm', 'familia': 'Herrajes', 'unidad': 'ud', 'precio_compra': 18.00, 'precio_venta': 23.50},
        {'nombre': 'Rodapié MDF blanco 7cm (barra 2,4m)', 'familia': 'Rodapiés', 'unidad': 'ud', 'precio_compra': 4.50, 'precio_venta': 6.00},

        # Otros
        {'nombre': 'Silicona neutra cartucho', 'familia': 'Sellantes', 'unidad': 'ud', 'precio_compra': 3.20, 'precio_venta': 4.50},
        {'nombre': 'Espuma poliuretano spray', 'familia': 'Sellantes', 'unidad': 'ud', 'precio_compra': 6.50, 'precio_venta': 8.50},
        {'nombre': 'Tornillería variada (caja)', 'familia': 'Ferretería', 'unidad': 'ud', 'precio_compra': 12.00, 'precio_venta': 15.00},
        {'nombre': 'Adhesivo cementoso (saco 25kg)', 'familia': 'Adhesivos', 'unidad': 'ud', 'precio_compra': 8.90, 'precio_venta': 11.50},
    ]
